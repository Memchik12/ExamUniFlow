export default function SettingsPage() {
    return (
        <div className="max-w-xl space-y-6 animate-in slide-in-from-left-4 duration-300">
            ...
            <div className="bg-white rounded-3xl border border-slate-200 p-8 space-y-6">
                ...
                <button className="w-full py-4 bg-red-50 text-red-500 font-black rounded-2xl hover:bg-red-500 hover:text-white transition-all">
                    ВЫЙТИ ИЗ АККАУНТА
                </button>
            </div>
        </div>
